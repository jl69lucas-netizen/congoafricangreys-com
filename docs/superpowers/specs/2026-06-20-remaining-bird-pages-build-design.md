...
- **RESOLVED — Amie §10 parents:** breeder confirmed Amie & Roys share parents (**James & Lois**) — they are siblings. Parent card restored with the shared photo (`/birds/amie/amie-parents.webp`, copied from Roys's) + reciprocal sibling cross-links between the two pages.
