...
grep -i "keyword\|query\|position" data/analytics/*/Queries.csv 2>/dev/null | head -50
```
...
- "African Grey CITES Appendix I: a buyer's complete guide"
