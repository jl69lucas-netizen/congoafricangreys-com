...
2. **Read** `site/content/male-vs-female-african-grey-parrots-for-sale/` — the reference page. If that file doesn't exist yet, use the static archive at `archive/simply-static-1-1775169284.zip` as structural reference only.
